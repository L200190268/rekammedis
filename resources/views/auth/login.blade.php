                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image:url('img/bg1.jpeg'); background-size: cover;">
                                <span class="mask bg-gradient-secondary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Rekam Medis"</h4>
                                <p class="text-white position-relative">Dokumen penting yang berisi informasi medis tentang seorang pasien, termasuk riwayat penyakit, diagnosis, pengobatan, dan hasil tes.</p>
                            </div>
                        </div>
                    </div>
                </div>
